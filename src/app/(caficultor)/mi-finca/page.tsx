  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8]">
      <header className="border-b border-[#E8E4DD] bg-[#FAFAF8] px-4 py-4">
        <h1 className="text-xl font-bold text-[#252320]">Mi Finca</h1>
        <p className="text-sm text-[#736E64]">Gestiona tus lotes y análisis de suelo</p>
      </header>
      ...
      <div className="px-4 py-6">
        ...
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-[#D4B87A] bg-[#FDF6EC] p-6 text-center">
          ...
          <h2 className="text-lg font-bold text-[#252320]">Próximamente en Fase 2</h2>
          ...
          {PROXIMAMENTE.map(({ Icon, titulo, descripcion }) => (
            ...
            >
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#F5F3EF]">
                <Icon size={20} className="text-[#8B6914]" strokeWidth={1.75} aria-hidden />
              </div>
              <div>
