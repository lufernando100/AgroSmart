...
console.log('• Producción desplegada: GET /api/health (público) y GET /api/health/ready con Bearer HEALTH_CHECK_SECRET')
console.log('  Workflow GitHub: .github/workflows/verify-production.yml (secrets PRODUCTION_URL + HEALTH_CHECK_SECRET)\n')
